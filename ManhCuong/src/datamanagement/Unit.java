...
public class Unit implements IUnit {
	...
	private String uc;
	//Avoid variables with short names like "UN"(easily confused with uc)
	//Start variables with lower case letter
	private String UN;
	private float co2;
	private float co1;
	private float co4;
	private float co3;
	private float co5;
	private int a1, a2, ex;//Avoid variables with short names
	//should be final, avoid short name
	private StudentUnitRecordList rs;
	//Avoid short name, some mistakes with naming guidelines
	...
	// Parameter 'cutoff'  could be declared final
